...
/* 
 a1 and a3
 reference are pointing to the same object . a1 and a3 hascode
 ...
 integer representation of memory address. hashcode does  not care
 about the content of the object and i value . a1.i is same as 
 a2.i but we getting different memory address.a1 and  a3 are pointing to same object thats why same memory address.
 */