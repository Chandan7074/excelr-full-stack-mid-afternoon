class Employee 
{
	...
	Employee(int employeeId, String employeeName, String employeeDepartment, int employeeAge,
...
class MainDriver
{
	...
	{
		Employee emp1 = new Employee(101, "viajay", "full-stack", 55, 2000.0);
