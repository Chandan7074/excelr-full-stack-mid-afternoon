...
* + operator if it not found reference either left of right then the result will be 
considered as constant
* + operator if found reference either left of right or both then ut uses a new 
