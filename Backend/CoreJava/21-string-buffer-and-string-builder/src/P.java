...
* StringBuffer - equals,hashcode nit overrided
we cant compare two strings based on the content bcz of this
* Stirng is implementing Comparable interface, but not stringbuffer
...
StringBuffer
* + operator only overloaded with String but not StringBuffer
...
* similarly both are used for managing multiple characters
